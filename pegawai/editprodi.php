...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		$id = $_GET['id'];
		$data = mysqli_query($koneksi, "select * from prodi  where kode_prodi='$id'");
		$d= mysqli_fetch_array($data);
		?>
                     <form method="post" action="updateprodi.php">
                     <div class="form-group row">
                        <label for="kdprodi" class="col-sm-2 col-form-label">Kode Prodi</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="kdprodi" name="kodeprodi" value="<?php echo"".$d['kode_prodi']; ?>" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nmprodi" name="namaprodi"  value="<?php echo"".$d['nama_prodi'];?>" required>
                        </div>
                    </div>
