...
<?php }?>
 ...
 <a class="collapse-item" href="daftar.php">Daftar</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Form Daftar Login</h1>
    ...
    echo "".format_hari_tanggal($date); ?></h1>
                    ...
                    <label class="col-sm-2 col-form-label" for="status">Status User </label>
                    <div class="col-sm-10">
...
var keyword = document.getElementById('status');
var container = document.getElementById('status_id');
