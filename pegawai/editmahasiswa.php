...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		$id = $_GET['id'];
		$data = mysqli_query($koneksi, "select * from mahasiswa join prodi on mahasiswa.kode_prodi = prodi.kode_prodi where nim='$id'");
		...
		?>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namamhs" id="nmmhs" value="<?php echo"".$d['namamhs']?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="nim" id="nimmhs" readonly value="<?php echo"".$d['nim']?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="tempatlahir" id="tmptlhr" value="<?php echo"".$d['tempatlahir']?>"  required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="date" class="form-control" name="datelahir" id="tgllahir"  required value="<?php echo"".$d['tanggallahir']?>">
                        </div>
                    </div>
                    ...
                    <option value="<?php echo"".$d['kode_prodi']?>"><?php echo"".$d['nama_prodi']?></option>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="alamat" id="almt" rows="4" cols="69" placeholder="Silahkan Tulis Alamat Anda!" required><?php echo"".$d['alamat']?></textarea>
                        </div>
                    </div>
                ...
                <label for="ulasan" class="col-sm-2 col-form-label"></label>
                    ...
                    <label  class="btn btn-secondary">
                        ...
                        <input type="radio" name="options" id="option2" value="On Going" required> On Going
