...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div class="form-group row">
                        <label for="kdprodi" class="col-sm-2 col-form-label">Kode Prodi</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="kdprodi" name="kodeprodi" required>
                        </div>
                    </div>

                    
                    <div class="form-group row">
                        <label for="nmprodi" class="col-sm-2 col-form-label">Nama Prodi</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nmprodi" name="namaprodi" required>
                        </div>
                    </div>
  ...
  <!-- Untuk Menghapus Data Di Textboxt -->
	...
	document.getElementById('kdprodi').value = ""; 
