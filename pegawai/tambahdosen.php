            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namadsn" id="nmdsn" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="date" class="form-control" name="datelahir"  value="<?php echo"".date('Y-m-d') ?>" id="tgllhr" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="alamat" id="alamat" rows="4" cols="69" placeholder="Silahkan Tulis Alamat Anda!" required></textarea>
                        </div>
                    </div>
