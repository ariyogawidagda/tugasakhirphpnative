...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		$id = $_GET['id'];
		$data = mysqli_query($koneksi, "select * from pegawai where nip_pegawai='$id'");
		$d= mysqli_fetch_array($data);
		?>
                     <form method="post" action="updatepegawai.php">
                     <div class="form-group row">
                        <label for="nmpgw" class="col-sm-2 col-form-label">Nama Pegawai</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namapgw" id="nmpgw" value="<?php echo"".$d['nama_pegawai']?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="nip" id="nip" value="<?php echo"".$d['nip_pegawai']?>" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="tempatlahir" id="tmptlhr" value="<?php echo"".$d['tempatlahir_pegawai']?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="date" class="form-control" name="datelahir" value="<?php echo"".$d['tanggallahir_pegawai']?>" id="tgllhr" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="alamat" id="alamat" rows="4" cols="69" placeholder="Silahkan Tulis Alamat Anda!" required><?php echo"".$d['alamat_pegawai']?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="notelp" id="telp" value="<?php echo"".$d['telepon_pegawai']?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="email"  value="<?php echo"".$d['email_pegawai']?>" id="email" required>
                        </div>
                    </div>
  ...
  <!-- Untuk Menghapus Data Di Textboxt -->
    ...
    function eraseText() {
		document.getElementById('nmpgw').value = ""; 
