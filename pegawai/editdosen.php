...
<body id="page-top">
                ...
                <div class="container-fluid">
                     ...
                     <?php 
                        ...
                        if(isset($d['kode_prodi'])) {
                            $data1 = mysqli_query($koneksi, "select * from dosen join prodi on dosen.kode_prodi = prodi.kode_prodi where nip='$id'");
                            $d1= mysqli_fetch_array($data1);
                        }
                        ?>
                     <form method="post" action="updatedosen.php">
                     <div class="form-group row">
                        <label for="nmdsn" class="col-sm-2 col-form-label">Nama Dosen</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namadsn" id="nmdsn" value="<?php echo"".$d['namadosen'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="nip" id="nip"  value="<?php echo"".$d['nip'] ?>" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="tempatlahir" id="tmptlhr" value="<?php echo"".$d['tempat_lahir'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="date" class="form-control" name="datelahir"  value="<?php echo"".$d['tanggal_lahir'] ?>" id="tgllhr" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="alamat" id="alamat" rows="4" cols="69" placeholder="Silahkan Tulis Alamat Anda!" required><?php echo"".$d['alamat'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="notelp" id="telp" value="<?php echo"".$d['notelp'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="nmprodi">Kaprodi</label>
                    <div class="col-sm-10">
                    <select class="form-control"   name="kodeprodii" id="nmprodi" >
                        <!-- jika kaprodi -->
                        <?php 
                        if(isset($d['kode_prodi'])) {
                        ?>
                         <option  value="<?php echo $d1['kode_prodi'] ?>"> <?php echo $d1['nama_prodi'] ?> </option>
                        <?php }?>
                   
                    <option value=""> -Pilih- </option>
                    <?php 
                    $dosen= mysqli_query($koneksi,"select * from prodi");
  ...
  <!-- Untuk Menghapus Data Di Textboxt -->
    ...
    function eraseText() {
		document.getElementById('nmdsn').value = ""; 
