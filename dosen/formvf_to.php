...
<body id="page-top">
    ...
    if($cek['kode_prodi']=="004"){
        ...
        header("location:indexdosen.php?pesanto='gagal'");
    }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <label class="col-sm-2 col-form-label" for="nim_to">Nim Mahasiswa</label>
                    <div class="col-sm-10">
                    <select class="form-control"  name="nim" id="nim_to" onchange="changedata(this.value)" required>
                    <option>-Pilih-</option>
                    <?php
    
                    $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where tugasakhir.status_ta ='belum verifikasi' and mahasiswa.kode_prodi = '004' ");
...
?>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="kelas_to">Kelas</label>
                    <div class="col-sm-10">
