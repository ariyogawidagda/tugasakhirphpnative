        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control"  name="nim" id="nim_to" onchange="changedata(this.value)" required>
                    <option>-Pilih-</option>
                    <?php

                        
            $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where  mahasiswa.kode_prodi = '004' ");
...
?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control"  name="kelas" id="kelas_to" required>
    ...
    <script>
        var combobox1_to =  document.getElementById('sidangg');
...
combobox1_to.addEventListener('change',function(){
    ...
    //  eksekusi ajax
    xxhttp.open('GET','ajax/revisi_to.php?sidang='+ combobox1_to.value,true);
    xxhttp.send();
});
    </script>
...
function changedata(y){ 
	...
	document.getElementById('kelas_to').value = dtmhs[y].kelasmhs; 
