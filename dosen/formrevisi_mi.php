...
<body id="page-top">
    ...
    // mengecek kaprodi
    if($cek['kode_prodi']=="001"){

    }
    else{
        header("location:indexdosen.php?pesanmi='gagal'");
    }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Form Sidang</h1>
                    ...
                    <form action="prosessidang.php" method="post">
                  

                    <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="sidangg">Pilih Tampil Data</label>
                    <div class="col-sm-10">
                    <select class="form-control"  name="sidang" id="sidangg" required>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="nim">Nim Mahasiswa</label>
             
                    <div class="col-sm-10">
                    <select class="form-control"  name="nim" id="nim_mi" onchange="changedata(this.value)" required>
                    <option>-Pilih-</option>
                    <?php
                            ...
                            $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where   mahasiswa.kode_prodi = '001' ");
...
?>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="namamhs" id="namamhs" readonly required>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control"  name="kelas" id="kelas_mi" required>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea readonly  class="form-control" name="tugasakhir" id="judul" rows="4" cols="69" placeholder="Silahkan Tulis Judul Tugas Akhir Anda!" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="nippb1" readonly id="nippb1" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="nippb2" class="col-sm-2 col-form-label">Nip Pembimbing 2</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" readonly name="nippb2" id="nippb2" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" readonly name="nmdsn2" id="dsn2" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="tanggal" readonly id="tanggal" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="ulasan" id="ulasan" required rows="4" cols="69" placeholder="Silahkan Tulis  Ulasan Anda!" ></textarea>
                        </div>
                    </div>
                ...
                <label for="ulasan" class="col-sm-2 col-form-label"></label>
                    ...
                    <label class="btn btn-secondary"> 
                        <input type="radio" name="options" id="option1" value="lulus" required> Lulus
                    ...
                    <label  class="btn btn-secondary">
                        ...
                        <input type="radio" name="options" id="option2" value="revisi" required> Revisi
    ...
    <!-- unntuk menampilkan nim ketika kelas dipiliih -->
    <script>
        
var combobox2_mi =  document.getElementById('nim_mi');
var combobox3_mi =  document.getElementById('sidangg');
// untuk formta_tl
combobox3_mi.addEventListener('change',function(){
    // membuat object ajax
    ...
    xxhttp.onreadystatechange = function() {
        if(xxhttp.readyState == 4 && xxhttp.status == 200) {
            combobox2_mi.innerHTML = xxhttp.responseText;
        }
    }

    //  eksekusi ajax
    xxhttp.open('GET','ajax/revisi_mi.php?pilih=' + combobox3_mi.value,true);
...
function changedata(y){ 
    ...
    document.getElementById('nippb2').value = dtmhs[y].nipdsn2; 
	document.getElementById('dsn2').value = dtmhs[y].nmdsn2; 
	document.getElementById('kelas_mi').value = dtmhs[y].kelasmhs; 
