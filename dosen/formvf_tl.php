        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <label class="col-sm-2 col-form-label"  for="nim_tl">Nim Mahasiswa</label>
                    <div class="col-sm-10">
                    <select class="form-control"  name="nim" id="nim_tl" onchange="changedata(this.value)" required>
                    <option>-Pilih-</option>
                    <?php
    
                    $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where tugasakhir.status_ta ='belum verifikasi' and mahasiswa.kode_prodi = '002' ");
...
?>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" readonly name="namamhs" id="namamhs" required>
                        </div>
                    </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="kelas_tl">Kelas</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control"  readonly name="tugasakhir" id="judul" rows="4" cols="69" placeholder="Silahkan Tulis Judul Tugas Akhir Anda!" required></textarea>
                        </div>
                    </div>
