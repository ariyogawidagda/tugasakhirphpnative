...
<body id="page-top">
    ...
    // mengecek kaprodi
    if($cek['kode_prodi']=="002"){

    }
    else{
        header("location:indexdosen.php?pesantl='gagal'");
    }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control"  name="nim" id="nim_tl" onchange="changedata(this.value)" required>
                    <option>-Pilih-</option>
                    <?php

                        
                         
    $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where  mahasiswa.kode_prodi = '002' ");
...
?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control"  name="kelas" id="kelas_tl" required>
    ...
    <script>
        var combobox1_tl =  document.getElementById('sidangg');
...
combobox1_tl.addEventListener('change',function(){
    ...
    //  eksekusi ajax
    xxhttp.open('GET','ajax/revisi_tl.php?sidang='+ combobox1_tl.value,true);
    xxhttp.send();
});
    </script>
...
function changedata(y){ 
	...
	document.getElementById('kelas_tl').value = dtmhs[y].kelasmhs; 
