        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where tugasakhir.status_ta ='belum verifikasi' and mahasiswa.kode_prodi = '001' ");
...
?>
    ...
    <script>
        var combobox1_mi =  document.getElementById('kelas_mi');
var combobox2_mi =  document.getElementById('nim_mi');
// untuk formta_tl
combobox1_mi.addEventListener('change',function(){
    // membuat object ajax
    ...
    //  eksekusi ajax
    xxhttp.open('GET','ajax/vf_mi.php?kelas='+ combobox1_mi.value,true);
    xxhttp.send();
});
    </script>


     <!-- untuk menampilkan nama dosen ketika nama di tulis -->
