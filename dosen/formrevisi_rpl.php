...
$dtmhs= mysqli_query($koneksi,"select * from tugasakhir join mahasiswa on tugasakhir.nim_mhs = mahasiswa.nim where   mahasiswa.kode_prodi = '003' ");
...
?>
    ...
    <script>
        var combobox1_rpl =  document.getElementById('sidangg');
...
combobox1_rpl.addEventListener('change',function(){
    ...
    //  eksekusi ajax
    xxhttp.open('GET','ajax/revisi_rpl.php?sidang='+ combobox1_rpl.value,true);
    xxhttp.send();
});
    </script>
