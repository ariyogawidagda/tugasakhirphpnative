...
<body id="page-top">
    <!-- untuk memberikan notif -->
<?php 

if(isset($_GET['pesan1'])=="gagal"){
?>
<script>
   ...
   <a class="collapse-item" href="upload_ab.php">Upload Abstract</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Form Pendaftaraan Tugas Akhir</h1>
    ...
    echo "".format_hari_tanggal($date); ?></h1>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nmmhs" readonly name="namamhs" value="<?php
    ...
    ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nim" name="nimmhs" readonly value="<?php
    ...
    ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="tugasakhir" id="judul" rows="4" cols="69" placeholder="Silahkan Tulis Judul Tugas Akhir Anda!" required></textarea>
                        </div>
                    </div>
                    
                    <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="nippb1">Nip Pembimbing 1 </label>
                    <div class="col-sm-10">
                    <select class="form-control"  name="nippb1" id="nippb1" onchange="changeValue1(this.value)" required>
                    <option>-Pilih-</option>
                    <?php $dosen= mysqli_query($koneksi,"select * from dosen");
                    $jsArray1 = "var dtDosen1 = new Array();\n"; 
                    while($row= mysqli_fetch_array($dosen)){
                        echo "<option value='$row[nip]'> $row[nip] </option>";
                        $jsArray1 .= "dtDosen1['" . $row['nip'] . "'] = {nama:'" . addslashes($row['namadosen']) . "'};\n";
                    }  
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="nmdsn1" id="dsn1" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <button class="btn btn-primary" type="button" onclick="javascript:eraseText();">Clear</button>
                        </div>
                    </div>
</form>
    ...
    <script src="../vendor/datatables/dataTables.bootstrap4.min.js"></script>
                    ...
                    <!-- ketika nip dipilih nama langsung terganti -->
                    <script type="text/javascript">
<?php echo $jsArray1; ?>
function changeValue1(nippb1){ 
    document.getElementById('dsn1').value = dtDosen1[nippb1].nama; 
    ...
    <!-- untuk ajax -->
    <script src="listnip.js"></script>

    <!-- Untuk Menghapus Data Di Textboxt -->
	<script type="text/javascript">
    function eraseText() {
		document.getElementById('nippb1').value = "-Pilih-"; 
	document.getElementById('dsn1').value = ""; 
