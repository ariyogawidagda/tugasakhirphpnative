...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- ketika button di update di klik, maka akan mengambil nilai dan melakukan update -->
                    <?php 
    ...
    <?php if($file_size < 2048000 and ($type =='application/vnd.openxmlformats-officedocument.wordprocessingml.document' or $type == 'application/pdf')){?>
        <script>
        alert("File Berhasil Di Upload!");
    </script>
    <?php  
   mysqli_query($koneksi,"update up_paper set nama_file_paper ='$name',tipe_paper='$type',file_paper='$file' where tgs_id_paper ='$id'");
    } else { ?>
  <script>
    ...
    <button name="btnn">Update</button>
    ...
    <?php 
        ...
        <!-- untuk menampilkan file yang di upload -->
