...
<body id="page-top">
    ...
    if(isset($cek2['nim_mhs'])){
        ...
        // untuk megambil id_Ta dan status_Ta dan nama
       ...
       else if($status_ta=="belum verifikasi"){
        header("location:indexmhs.php?ab='gagal'");
       }else if($status_ta=="lulus"){
        header("location:indexmhs.php?abls='gagal'");
       }else if($status_ta=="revisi"){
 ...
 <a class="collapse-item" href="listtugasakhir.php">Tugas Akhir</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Form Upload Abstract</h1>
    ...
    <?php  
    mysqli_query($koneksi,"insert into  up_abstract (nama_file,tipe_file,file,tgs_id) VALUES ('$name','$type','$file','$id')");
    } else{ ?>
  <script>
    ...
    <?php 
        ...
        <a   href="view_abstract.php?id=<?php echo $cek['id_ta']; ?>" target="_blank"><?php echo $cek1['nama_file']; ?></a>
