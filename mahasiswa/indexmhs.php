...
<body id="page-top">
    <!-- untuk notif belum verifikasi up_ab -->
    <?php 
    if(isset($_GET['ab'])=="gagal")
    {
    ?>
    <script>
        alert("Data Belum Di Verifikasi!");
    </script>

        <?php } elseif(isset($_GET['abb'])=="gagal") {?>
            <script>
            alert("Silahkan Daftar Tugas Akhir Terlebih Dahulu!");
        </script>
            <?php } elseif(isset($_GET['abls'])=="gagal") {?>
                <script>
            alert("Tidak Bisa Mengubah Data !");
        </script>
            <?php }  elseif(isset($_GET['abrs'])=="gagal") {?>
                <script>
            alert("Silakan Edit Data !");
        </script>
