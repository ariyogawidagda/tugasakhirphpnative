...
<body id="page-top">
    ...
    <?php 
    if(isset($_GET['pesanup'])=="berhasil"){
 ...
 <a class="collapse-item" href="listtugasakhir.php">Tugas Akhir</a>
   ...
   <a class="collapse-item" href="upload_ab.php">Upload Abstract</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Status Tugas Akhir</h1>
    ...
    echo "".format_hari_tanggal($date); ?></h1>
                    ...
                    <form method="post" action="prosesta.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="nmmhs" readonly value="<?php echo"".$d['nim_mhs'] ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="tugasakhir" id="judul" rows="4" cols="69"  readonly><?php  echo"".$d['judul']?></textarea>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea  class="form-control" name="tugasakhir" id="judul" rows="4" cols="69"  readonly><?php echo"".$d['ulasan'] ?></textarea>
                        </div>
                    </div>
                    <!-- mengambil nilai database  ketika sudah upload file abstract dan paper-->
                    <?php 
                    // mengambil data abstract
                      $data2=mysqli_query($koneksi,"select * from tugasakhir join up_abstract 
                      on tugasakhir.id_ta = up_abstract.tgs_id  where tugasakhir.nim_mhs='$user'");
                      $d2=mysqli_fetch_array($data2);


                        // mengambil data paper
                        $data3=mysqli_query($koneksi,"select * from tugasakhir join up_paper on tugasakhir.id_ta = up_paper.tgs_id_paper where tugasakhir.nim_mhs='$user'");
                      $d3=mysqli_fetch_array($data3);
                      

                    ?>

                    <!-- menampilkan form jika nilai dari tgs_id ada -->

                    <?php if(isset($d2['tgs_id'])) {?>

                        <div class="form-group row">
                        <label for="dsn2" class="col-sm-2 col-form-label">File Abstract</label>
                        <div class="col-sm-10">
                       <a href="view_abstract.php?id=<?php echo $d2['id_ta']; ?>" target="_blank"> <input type="text" class="form-control" name="nmdsn2" id="dsn2" readonly value="<?php echo"".$d2['nama_file'] ?>"></a>
                        </div>
                    </div>
                        ...
                        <?php } ?>
                         ...
                         <!-- menampilkan form jika nilai dari tgs_id_paper ada -->
                        <?php if(isset($d3['tgs_id_paper'])) { ?>

                            
                        <div class="form-group row">
                        <label for="dsn2" class="col-sm-2 col-form-label">File Paper</label>
                        <div class="col-sm-10">
                       <a href="view_paper.php?id=<?php echo $d3['id_ta']; ?>" target="_blank"> <input type="text" class="form-control" name="nmdsn2" id="dsn2" readonly value="<?php echo"".$d3['nama_file_paper'] ?>"></a>
                        </div>
                    </div>
                            <?php }?>

                            <!-- menampilkan form jika nilai dari status_ta ditolak  -->
                            <?php if($d['status_ta']=="ditolak"){ ?>

                                <div class="form-group row">
                        <div class="col-sm-10">
                      <a  class="btn btn-primary" href="editta.php"> Edit </a>
                        </div>
                    </div>

                           <?php }  elseif($d['status_ta']=="revisi"){?>

                            
                            <div class="form-group row">
                        <div class="col-sm-10">
                      <a  class="btn btn-primary" href="update_pp.php"> Edit </a>
                        </div>
                    </div>
